...
export const Luggage = () => {
  ...
  return (
    <View style={styles.container}>
        <ScrollView>
          <Image source={{uri:'https://images.pexels.com/photos/2646521/pexels-photo-2646521.jpeg?auto=compress&cs=tinysrgb&w=400'}} style={styles.image}/>
          <View style={styles.contents}>
          <View style={styles.opacity}></View>
            <Text style={styles.title}>Luggage</Text>
            <Text style={styles.minititle}>Shop suitcase, carry-ons, backpacks, travel totes, kids luggage and more</Text>
          </View>
